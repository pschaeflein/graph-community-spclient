...
namespace Graph.Community.Models
{
    ...
    public class HubSite : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Graph.Community.Models.HubSite"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Graph.Community.Models.HubSite CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Graph.Community.Models.HubSite();
        }
        /// <summary>
